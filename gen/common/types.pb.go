...
func (x *TransferStatement) Reset() {
	*x = TransferStatement{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransferStatement) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferStatement) ProtoMessage() {}

func (x *TransferStatement) ProtoReflect() protoreflect.Message {
	mi := &file_common_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferStatement.ProtoReflect.Descriptor instead.
func (*TransferStatement) Descriptor() ([]byte, []int) {
	return file_common_types_proto_rawDescGZIP(), []int{2}
}

func (x *TransferStatement) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_common_types_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0x16, 0x0a, 0x04, 0x55,
	0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x43, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12,
	...
	0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x27, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x12, 0x0a,
	...
	0x6c, 0x79, 0x66, 0x65, 0x79, 0x76, 0x75, 0x74, 0x68, 0x61, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x41,
	0x54, 0x43, 0x62, 0x61, 0x6e, 0x6b, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
...
var file_common_types_proto_goTypes = []interface{}{
	...
	(*Transfer)(nil),          // 1: types.Transfer
	(*TransferStatement)(nil), // 2: types.TransferStatement
}
var file_common_types_proto_depIdxs = []int32{
	0, // 0: types.Transfer.user:type_name -> types.User
...
func file_common_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransferStatement); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
